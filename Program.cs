...
namespace APA_Partition_Header_Checksumer
{
    class Program
    {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("APA_Partition_Header_Checksumer.exe Help");
            Console.WriteLine("Show this Message");
            Console.WriteLine("");
            Console.WriteLine("APA_Partition_Header_Checksumer.exe partition.apa");
            Console.WriteLine("Calculate Checksum for an APA Partition");
            Console.WriteLine("");
